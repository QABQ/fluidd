<template>
  <collapsable-card
    :title="$t('ToolheadSettingsCard.Tool')"
    cardKey="ToolSettings"
    icon="$printer3dNozzle">
    <v-card-text>
      <v-switch
        class="mt-0 mb-4"
        :label="$t('ToolheadSettingsCard.Invert X')"
        hide-details
        v-model="invertX">
      </v-switch>
      <v-switch
        class="mt-0 mb-4"
        :label="$t('ToolheadSettingsCard.Invert Y')"
        hide-details
        v-model="invertY">
      </v-switch>
      <v-switch
        class="mt-0 mb-4"
        :label="$t('ToolheadSettingsCard.Invert Z')"
        hide-details
        v-model="invertZ">
      </v-switch>
      <v-text-field
        filled
        :label="$t('ToolheadSettingsCard.Default Extrude Length')"
        suffix="mm"
      ...
      <v-select
        filled
        :label="$t('ToolheadSettingsCard.Default toolhead move length')"
        suffix="mm"
      ...
      <v-text-field
        filled
        :label="$t('ToolheadSettingsCard.Toolhead XY Move Speed')"
        suffix="mm/s"
        v-model="defaultToolheadXYSpeed"
      ></v-text-field>
      <v-text-field
        filled
        :label="$t('ToolheadSettingsCard.Toolhead Z Move Speed')"
        suffix="mm/s"
