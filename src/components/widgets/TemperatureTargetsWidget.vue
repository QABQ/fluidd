            ...
            <v-list
              ...
              <v-list-item
                ...
                <v-list-item-title>
                  ...
                  {{$t('TemperatureTargetsWidget.All off')}}
                </v-list-item-title>
              </v-list-item>
              <v-list-item
                link
