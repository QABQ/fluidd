  ...
  <v-card-text>
    <v-row class="my-0 mb-4">
      <v-col cols="12" sm="6" class="py-0">
        <input-slider
          :label="$t('PrinterLimitsWidget.Velocity')"
          value-suffix="mm/s"
          input-sm
      ...
      <v-col cols="12" sm="6" class="py-0">
        <input-slider
          :label="$t('PrinterLimitsWidget.Square Corner Velocity')"
          value-suffix="mm/s"
          input-sm
          :value="scv.current"
          :min="0"
    ...
    <v-row class="my-0">
      <v-col cols="12" sm="6" class="py-0">
        <input-slider
          :label="$t('PrinterLimitsWidget.Acceleration')"
          value-suffix="mm/s^2"
          input-sm
          :value="accel.current"
          :min="1"
      ...
      <v-col cols="12" sm="6" class="py-0">
        <input-slider
          label="$t('PrinterLimitsWidget.Accel to Decel')"
          value-suffix="mm/s^2"
          input-sm
          :value="decel.current"
          :min="1"
