  ...
  <div>
    <v-btn-toggle v-if="!readonly">
      <v-tooltip dense top>
        ...
        <span>{{$t('FileSystemControls.Add Folder')}}</span>
      </v-tooltip>
      ...
      <v-tooltip dense top>
        ...
        <span>{{$t('FileSystemControls.Create File')}}</span>
      </v-tooltip>
      ...
      <v-tooltip dense top>
        ...
        <span>{{$t('FileSystemControls.Upload')}}</span>
      </v-tooltip>
      ...
      <v-tooltip dense top>
        ...
        <span>{{$t('FileSystemControls.Upload & Print')}}</span>
      </v-tooltip>
      ...
      <v-tooltip dense top>
        ...
        <span>{{$t('FileSystemControls.Refresh')}}</span>
      </v-tooltip>
    </v-btn-toggle>
