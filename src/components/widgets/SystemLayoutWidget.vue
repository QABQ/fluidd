<template>
  <v-list dense>
    <v-subheader>{{$t('SystemLayoutWidget.Layout')}}</v-subheader>
    ...
    <v-list-item @click.prevent="layoutMode = !layoutMode">
      ...
      <v-list-item-content>
        <v-list-item-title>{{$t('SystemLayoutWidget.Adjust dashboard layout')}}</v-list-item-title>
      </v-list-item-content>
    </v-list-item>
    ...
    <v-list-item @click="resetLayout">
      ...
      <v-list-item-content>
        <v-list-item-title>{{$t('SystemLayoutWidget.Reset dashboard layout')}}</v-list-item-title>
      </v-list-item-content>
    </v-list-item>
  </v-list>
</template>
