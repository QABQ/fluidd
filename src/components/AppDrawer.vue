  ...
  <v-navigation-drawer
    ...
    <v-list dense>
      ...
      <v-list-item to="/" class="d-flex d-md-none">
        ...
        <v-list-item-content>
          <v-list-item-title>{{$t('AppDrawer.Dashboard')}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <v-list-item to="/jobs" class="d-flex d-md-none" v-if="klippyConnected">
        ...
        <v-list-item-content>
          <v-list-item-title>{{$t('AppDrawer.Jobs')}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <v-list-item to="/configuration" class="d-flex d-md-none">
        ...
        <v-list-item-content>
          <v-list-item-title>{{$t('AppDrawer.Printer Configuration')}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <v-list-item to="/settings">
        ...
        <v-list-item-content>
          <v-list-item-title>{{$t('AppDrawer.UI Settings')}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <v-divider></v-divider>
